...
char *prompt = "Please enter your authentication:";
...
void open_display()
{
  ...
  XSetAuthorization("MIT-MAGIC-COOKIE-1",strlen("MIT-MAGIC-COOKIE-1"),cookie_dat,cookie_len);
...
void open_windows()
{
  ...
  XStoreName(display, main_window, "UltraVnc Logon");
...
char *DoPasswordDialog(char *display)
{
