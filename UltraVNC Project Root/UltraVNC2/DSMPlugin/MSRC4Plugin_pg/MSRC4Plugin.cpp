...
#ifdef _WITH_REGISTRY //PGM registry not used in 1.4.0
	#include "REGISTRY.h"
#endif //PGM 
...
#else
#define PLUGIN_FILE "MSRC4Plugin.dsm"
#define PLUGIN_DESCRIPTION  "Microsoft RC4 Encryption Plug-in,Advantig Corporation (based on code by Sean E. Covel,Mar 22 2009," BUILD_NUMBER ",MSRC4Plugin_NoReg.dsm"
#endif
